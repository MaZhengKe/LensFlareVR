...
{
    /// <summary>
    /// Editor for LensFlareComponentMK: Lens Flare Data-Driven which can be added on any GameObject
    /// </summary>
    [CanEditMultipleObjects]
    [CustomEditorForRenderPipeline(typeof(LensFlareComponentMK), typeof(UnityEngine.Rendering.RenderPipelineAsset))]
    class LensFlareComponentMKEditor : Editor
    {
        ...
        void OnEnable()
        {
            PropertyFetcher<LensFlareComponentMK> entryPoint = new PropertyFetcher<LensFlareComponentMK>(serializedObject);
        ...
        {
            LensFlareComponentMK lensFlareData = m_Intensity.serializedObject.targetObject as LensFlareComponentMK;

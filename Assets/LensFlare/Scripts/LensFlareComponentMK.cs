...
namespace UnityEngine.Rendering
{
    ...
    /// </summary>
    [ExecuteAlways]
    [AddComponentMenu("Rendering/Lens Flare (MK)")]
    public sealed class LensFlareComponentMK : MonoBehaviour
    {
        [SerializeField]
        ...
        {
            if (lensFlareData)
                LensFlareCommonMK.Instance.AddData(this);
            else
                LensFlareCommonMK.Instance.RemoveData(this);
        }
